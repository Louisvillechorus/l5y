...
1:'COLD OPEN, NO PHONE. One GO: the title page tears off the calendar and falls, and beneath it the date holds — JUNE · YEAR 5, the morning after — center-stage through the whole prologue. On her verse-two line the calendar docks and her phone rises and plays out on its own: the Memories notification she ignores, Messages, his thread — days of her asking, a Thursday of silence — and she types her text and SENDS. Delivered, then READ 9:44. His typing bubble rises. It stops. Then she opens the Memories: four cards, four years, and she drifts back up to the bear and stays there until the phone goes.',
 ...
 12:'THE DRIVE, ON THE DASH. The calendar rolls back and holds; then it docks and CarPlay takes the frame for the rest of the song: Apple Maps, the puck riding the route from New York to the Eastern Shore, the miles and minutes falling, each maneuver counting down, the drive in real time. The exit for the Delaware Memorial Bridge comes mid-song and she never arrives before the last chord (tune `rate`/`startAt` in tech). On the final chord the dash goes dark and NOVEMBER · YEAR 1 holds.',
